      ...
      >
        ...
        <div className="p-4 border-t space-y-4">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="https://facebook.com/116595617969941" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-primary-600 min-h-[48px] min-w-[48px] flex items-center justify-center" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/les.nouveaux.comparateurs/" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-primary-600 min-h-[48px] min-w-[48px] flex items-center justify-center" aria-label="Instagram">
            ...
            <a href="https://x.com/eric_margulies" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-primary-600 min-h-[48px] min-w-[48px] flex items-center justify-center" aria-label="X (Twitter)">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://linkedin.com/in/eric-margulies-6a093825b" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-primary-600 min-h-[48px] min-w-[48px] flex items-center justify-center" aria-label="LinkedIn">
