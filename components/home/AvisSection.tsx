...
const REVIEWS = [
  ...
  },
  {
    name: "Michel R.",
    location: "Dieppe",
    text: "Enfin un courtier qui prend le temps d'expliquer les garanties. J'ai pu économiser plus de 70€ par mois sans perdre en couverture.",
    rating: 5,
  ...
  },
  {
    name: "Gilbert F.",
    location: "Compiègne",
    text: "Bonne prestation dans l'ensemble. Le conseiller a pris le temps de m'expliquer les différences entre les formules. Je recommande.",
    rating: 4,
    avatar: "/images/avatars/gilbert.jpg",
  },
  {
    name: "Suzanne P.",
    location: "Saint-Valery-sur-Somme",
    text: "Très satisfaite de mon passage chez Les Nouveaux Comparateurs. On m'a proposé une mutuelle adaptée à mes besoins et à mon budget. Merci !",
    rating: 5,
    avatar: "/images/avatars/suzanne.jpg",
  },
  {
    name: "Andrée B.",
    location: "Eu",
    text: "Un service agréable et efficace. Le conseiller était ponctuel et bien préparé. J'aurais aimé un peu plus de détails sur certaines garanties.",
    rating: 4,
    avatar: "/images/avatars/andree.jpg",
  },
  {
    name: "Gérard V.",
    location: "Mers-les-Bains",
    text: "Contact humain et chaleureux. On m'a bien conseillé sur la complémentaire santé qui correspondait à ma situation de retraité.",
    rating: 5,
    avatar: "/images/avatars/gerard.jpg",
  },
  {
    name: "Denise C.",
    location: "Ault",
    text: "Professionnalisme et bienveillance. Les explications étaient claires, sans jargon. Je me suis sentie en confiance du début à la fin.",
    rating: 5,
